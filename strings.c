...
lval* builtin_load(lenv* e, lval* a) {
  ...
  mpc_result_t r;
  if (mpc_parse_contents(a->cell[0]->str, adlisp, &r)) {
...
int main(int argc, char** argv) {
  ...
  mpca_lang(MPCA_LANG_DEFAULT,
    "                                              \
      ...
      adlisp   : /^/ <expr>* /$/ ;                  \
    ",
    Number, Symbol, String, Comment, Sexpr, Qexpr, Expr, adlisp);
  ...
  if (argc == 1) {
    ...
    while (1) {
      ...
      mpc_result_t r;
      if (mpc_parse("<stdin>", input, adlisp, &r)) {
